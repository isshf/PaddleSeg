...
MODEL_NAME = 'hrnet18_noniterative_baseline_5_31'
...
def init_model(cfg):
    ...
    model = HRNetModel(width=18, ocr_width=64, with_aux_output=True, use_leaky_relu=True,
                       use_rgb_conv=False, use_disks=True, norm_radius=5, with_prev_mask=False, small=False)
